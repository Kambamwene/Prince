...
class RangeSliderView extends StatefulWidget {
  const RangeSliderView({Key key, this.values, this.onChangeRangeValues,this.onChangeEnd,this.min=0,this.max=100000000})
      : super(key: key);
        ...
        Row(
          ...
          children: [
            SizedBox(
              //width: 54,
              child: Text(
                currencyFormatter(_values.start.round()),
             ...
             SizedBox(
                  //width: 54,
                  child: Text(
                    currencyFormatter(_values.end.round()),
                    textAlign: TextAlign.center,
                  ),
                ),
          ],
